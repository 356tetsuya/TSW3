...
public class TestaConexaoComDB {
	...
	/**
	 * Objetivo - verificar o comportamento do sistema na conexao ao DB com senha de
	 * acesso invalida Pré-condição - o usuario valido e root"
	 */
	@Test
	...
	/**
	 * Objetivo - verificar o comportamento do sistema na conexao ao DB com senha de
	 * acesso invalida Pré-condição - o driver valido e root"
	 */
	@Test
	 ...
	 */
	@Test
	public void quandoConectaURLInvalida_SQLException() {
		// cenario
		String url = "jdbc:mysql://localhost:3333/biblioteca";
		String driver = "com.mysql.jdbc.Driver";
		String usuario = "root";
		String senha = ""; 
		FabricaDeConexoes fabricaDeConexoes = null;
